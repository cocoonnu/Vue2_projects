        ...
        <div class="main">
            <div class="py-container">
                ...
                <div class="bread">
                    ...
                    <ul class="fl sui-tag">
                        <li class="with-x" v-if="dataname">{{dataname}}<i>×</i></li>
                    </ul>
                </div>
                        ...
                        <ul class="yui3-g">
                            <li class="yui3-u-1-5" v-for="good in goodsList" :key="good.id">
                                <div class="list-wrap">
                                    ...
                                    <div class="commit">
                                        <i class="command">已有<span>{{10 + Math.floor(Math.random() * 100) + 'k'}}</span>人评价</i>
                                    </div>
                                    <div class="operate">
...
<script>
    ...
    export default {
        ...
        watch: {
            $route: {
                handler(newValue) {
                    this.searchParams.categoryName = this.dataname;
                    this.searchParams.keyword = this.value;
